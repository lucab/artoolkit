...
* \param area XXXBK
* \param id marker identity number
* \param dir XXXBK
...
* \param vertex marker coordinates (in ideal screen coordinates)
*/
typedef struct {
    int     area;
    int     id;
...
* 
* Store information after contour detection.
* \param area XXXBK
* \param pos center of marker (in ideal screen coordinates)
* \param coord_num numer of pixels in the contour.
* \param x_coord x coordinate of pixels of contour.
* \param y_coord y coordinate of pixels of contour.
* \param vertex marker coordinates (in ideal screen coordinates)
* 
*/
typedef struct {
